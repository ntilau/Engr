...
%%%%%%%%%%%%%%%%%%%
%% Purging
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_6_intp\S_f_3000000000_8000000000_1001_EPSILON_RELATIVE_Box1_5_5_1_EPSILON_RELATIVE_Box2_3_3_1_purging.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
  = loadSmatrix(fNameSpara);
% one parameter plot
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_6_intp\S_f_3000000000_8000000000_1001_EPSILON_RELATIVE_Box1_5_5_1_EPSILON_RELATIVE_Box2_3_3_1_p1e-7.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
  = loadSmatrix(fNameSpara);
% one parameter plot
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_6_intp\S_f_3000000000_8000000000_1001_EPSILON_RELATIVE_Box1_5_5_1_EPSILON_RELATIVE_Box2_3_3_1_o7.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
  = loadSmatrix(fNameSpara);
% one parameter plot
...
%   sShort(fCnt) = s(find(freqs == fr(fCnt)));
  ...
  sValIntpPrgShort(fCnt) = sValIntpPrg(logical(freqsNprg == fr(fCnt)));
%   sValIntpPrgShort6(fCnt) = sValIntpPrg6(find(freqsNprg6 == fr(fCnt)));
  sValIntpShorto7(fCnt) = sValIntpo7(logical(freqsNo7 == fr(fCnt)));
  sValIntpShort_o8p7(fCnt) = sValIntp_o8p7(logical(freqsN_o8p7 == fr(fCnt)));
