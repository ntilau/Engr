...
% mesh.fine   = [ROOTPATH 'GEO/WR90SlabOldFine2.fem'];
% mesh.fine   = [ROOTPATH 'GEO/WR90Slab_finemesh.fem'];
% mesh.fine   = [ROOTPATH 'GEO/WR90Slab_finemeshFett.fem'];
% mesh.fine   = [ROOTPATH 'GEO/WR90Slab_finermeshFett.fem'];
...
% short waveguide with layer
% mesh.dd   = [ROOTPATH 'GEO/WR90SlabOldcoarse.fem'];
% mesh.dd   = [ROOTPATH 'GEO/WR90Slab_coarsemesh.fem'];
...
interpolationPnts.mu{1}.N(1)      = 5;%11;
