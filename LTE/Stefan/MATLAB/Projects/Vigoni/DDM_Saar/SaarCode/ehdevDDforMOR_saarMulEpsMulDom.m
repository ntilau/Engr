...
[S, T, Sdiel, Tdiel] = getGlobalST_MulEpsMulDom(CS, CT, CSd, CTd, nrOfMatDom) ;
...
for matDomCnt = 1 : nrOfMatDom
  compMatSdiel{matDomCnt} = tfMat.' * Sdiel{matDomCnt} * tfMat;
  compMatTdiel{matDomCnt} = tfMat.' * Tdiel{matDomCnt} * tfMat;
end
