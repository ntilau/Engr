function [BLOCK, CS, CT] = BuildFemDDM_saar_MulEpsMulDom(MESH, xy, nlab, iNODEc, PO, Np, LPEC, LPMC, ndie, material, plane, nuRel, epsRel, ND, nrOfMatDom)
