...
% mesh.fine   = [ROOTPATH 'GEO/fourPostsFine.fem'];
% mesh.fine   = [ROOTPATH 'GEO/fourPostsFineNew.fem'];
mesh.fine   = [ROOTPATH 'GEO/fourPostsNotSoFine.fem'];
...
% empty waveguide with four dielectric posts
mesh.dd   = [ROOTPATH 'GEO/fourPostsCoarse.fem'];
...
interpolationPnts.epsilon{2}.N(1)      = 2;%11;
interpolationPnts.epsilon{2}.mlabel(1) = 3;
interpolationPnts.epsilon{2}.domain    = -1;

flagout = 1;

[unredModel, solVecs, results, sweep, nmode, xy, PO, Np, MESH] = ehdevDDforMOR_saarMulEpsMulDom(mesh, interpolationPnts, flagout);
