function ROM = buildROM_MultipleEpsilon(unredModel, solVecs)
...
ROM.S = U' * unredModel.S * U;
ROM.T = U' * unredModel.T * U;
for dielCnt = 1 : length(unredModel.Sdiel)
  ROM.Sdiel{dielCnt} = U' * unredModel.Sdiel{dielCnt} * U;
  ROM.Tdiel{dielCnt} = U' * unredModel.Tdiel{dielCnt} * U;
end
