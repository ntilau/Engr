...
// 	double a[36] = { 7.0, 0.0, 1.0, 0.0, 2.0, 0.0, 7.0, 0.0, 
// 		-4.0, 0.0, 8.0, 0.0, 2.0, 0.0, 
// 		1.0, 0.0, 5.0, 0.0, 
// 		7.0, 0.0, 9.0, 0.0, 
// 		5.0, 0.0, 1.0, 0.0, 5.0, 0.0, 
// 		-1.0, 0.0, 5.0, 0.0, 
// 		11.0, 0.0, 
// 		5.0, 0.0 };
// 	MKL_INT mtype = -2; /* Real symmetric matrix indefinite*/
	MKL_INT mtype = 6; /* Complex symmetric matrix */
	/* RHS and solution vectors. */
	double b[8], x[8];
  MKL_Complex16 b_c[8], x_c[8];
// 	double b[16], x[16];
  ...
  printf("Size of MKL_Complex16: %d\n", sizeof(MKL_Complex16));
/* -------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------- */
	...
	PARDISO (pt, &maxfct, &mnum, &mtype, &phase,
		&n, (double *)a_c, ia, ja, &idum, &nrhsI,
		iparm, &msglvl, (double *)b_c, (double *)x_c, &error);
	if (error != 0) {
	...
	for (i = 0; i < n; i++) {
		printf("\n x_c[%d] = (%e,%e)", i, x_c[i].real, x_c[i].imag);
	}
	printf ("\n");
/* -------------------------------------------------------------------- */
