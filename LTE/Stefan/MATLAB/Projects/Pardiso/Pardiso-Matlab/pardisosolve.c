...
/*
    ...
    mex -O -largeArrayDims -lmwrefblas -output pardisoinit    ./libpardiso_GNU64_AMD64_INT64_P.so pardisoinit.c
    mex -O -largeArrayDims -lmwrefblas -output pardisoreorder ./libpardiso_GNU64_AMD64_INT64_P.so pardisoreorder.c
    mex -O -largeArrayDims -lmwrefblas -output pardisofactor  ./libpardiso_GNU64_AMD64_INT64_P.so pardisofactor.c
    mex -O -largeArrayDims -lmwrefblas -output pardisosolve   ./libpardiso_GNU64_AMD64_INT64_P.so pardisosolve.c
    ...
    Notice:
        ...
        Copyright (c)  2007, 2006, 2005, 2004  University of Basel.
        All Rights Reserved.
...
)
{
    ...
    int      mtype, error, maxfct, mnum, msglvl, phase;
    ...
    double *bR ;		/* real numerical values of rhs b */   
    double *xR ;		/* real numerical values of solution x */  
   
    int j, k, i, ptr ;		/* loop counter */
    int nnz, Pnrhs = 1;		/* nonzeros in A */
    ...
    mwIndex     *A_ia_sym;	/* real symmetric IA of input matrix A */  
    mwIndex     *A_ja_sym;	/* real symmetric JA of input matrix A */  
