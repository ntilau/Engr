...
modelNameRom = 'C:\work\examples\MOR_Example_VoithSiemens\results\rom_100_Frequency_50_Dmpr_0_Impd_2_FreqOnly_1_orth\';
fNameResultsRom = [modelNameRom 'Frequency_0_100_201_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRom);
resultsRom100_orth = results;
paramSpaceRom100_orth = paramSpace;
fNameResultsRomFine = [modelNameRom 'Frequency_0_100_2001_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRomFine);
resultsRomFine100_orth = results;
paramSpaceRomFine100_orth = paramSpace;
modelNameRom = 'C:\work\examples\MOR_Example_VoithSiemens\results\rom_150_Frequency_50_Dmpr_0_Impd_2_FreqOnly_1_orth\';
fNameResultsRom = [modelNameRom 'Frequency_0_100_201_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRom);
resultsRom150_orth = results;
paramSpaceRom150_orth = paramSpace;
fNameResultsRomFine = [modelNameRom 'Frequency_0_100_2001_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRomFine);
resultsRomFine150_orth = results;
paramSpaceRomFine150_orth = paramSpace;
modelNameRom = 'C:\work\examples\MOR_Example_VoithSiemens\results\rom_200_Frequency_50_Dmpr_0_Impd_2_FreqOnly_1_orth\';
fNameResultsRom = [modelNameRom 'Frequency_0_100_201_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRom);
resultsRom200_orth = results;
paramSpaceRom200_orth = paramSpace;
fNameResultsRomFine = [modelNameRom 'Frequency_0_100_2001_Dmpr_0_100_1_Impd_2_100_1.mat'];
load(fNameResultsRomFine);
resultsRomFine200_orth = results;
paramSpaceRomFine200_orth = paramSpace;
outputId{1} = [1 1];
outputId{2} = [2 1];
outputId{3} = [3 1];
plotData = cell(length(outputId), 1);
...
plotDataRom100_orth = cell(length(outputId),1);
plotDataRomFine100_orth = cell(length(outputId),1);
plotDataRom150_orth = cell(length(outputId),1);
plotDataRomFine150_orth = cell(length(outputId),1);
for outCnt = 1 : length(outputId)
  plotData{outCnt} = plotResultsVS(resultsFull, params, paramSpaceFull, outputId{outCnt});
  close(gcf);
  plotDataRom{outCnt} = plotResultsVS(resultsRom, params, paramSpaceRom, outputId{outCnt});
  ...
  close(gcf);
  plotDataRom100_orth{outCnt} = plotResultsVS(resultsRom100_orth, params, paramSpaceRom100_orth, outputId{outCnt});
  close(gcf);
  plotDataRomFine100_orth{outCnt} = plotResultsVS(resultsRomFine100_orth, params, paramSpaceRomFine100_orth, outputId{outCnt});
  close(gcf);
  plotDataRom150_orth{outCnt} = plotResultsVS(resultsRom150_orth, params, paramSpaceRom150_orth, outputId{outCnt});
  close(gcf);
  plotDataRomFine150_orth{outCnt} = plotResultsVS(resultsRomFine150_orth, params, paramSpaceRomFine150_orth, outputId{outCnt});
  close(gcf);
  plotDataRom200_orth{outCnt} = plotResultsVS(resultsRom200_orth, params, paramSpaceRom200_orth, outputId{outCnt});
  close(gcf);
  plotDataRomFine200_orth{outCnt} = plotResultsVS(resultsRomFine200_orth, params, paramSpaceRomFine200_orth, outputId{outCnt});
  close(gcf);
end
...
semilogy(plotDataRom100_orth{1}.xData, abs(plotData{1}.yData-plotDataRom100_orth{1}.yData) ./ abs(plotData{1}.yData), ':', 'LineWidth', linewidth);
semilogy(plotDataRom150_orth{1}.xData, abs(plotData{1}.yData-plotDataRom150_orth{1}.yData) ./ abs(plotData{1}.yData), 'x:', 'LineWidth', linewidth);
semilogy(plotDataRom200_orth{1}.xData, abs(plotData{1}.yData-plotDataRom200_orth{1}.yData) ./ abs(plotData{1}.yData), 'o:', 'LineWidth', linewidth);
semilogy(plotDataRom50{2}.xData, abs(plotData{2}.yData - plotDataRom50{2}.yData) ./ abs(plotData{2}.yData), 'r--', 'LineWidth', linewidth);
semilogy(plotDataRom{2}.xData, abs(plotData{2}.yData - plotDataRom{2}.yData) ./ abs(plotData{2}.yData), 'r', 'LineWidth', linewidth);
semilogy(plotDataRom150{2}.xData, abs(plotData{2}.yData - plotDataRom150{2}.yData) ./ abs(plotData{2}.yData), 'r-.', 'LineWidth', linewidth);
semilogy(plotDataRom100_orth{2}.xData, abs(plotData{2}.yData-plotDataRom100_orth{2}.yData) ./ abs(plotData{2}.yData), 'r:', 'LineWidth', linewidth);
semilogy(plotDataRom150_orth{2}.xData, abs(plotData{2}.yData-plotDataRom150_orth{2}.yData) ./ abs(plotData{2}.yData), 'rx:', 'LineWidth', linewidth);
semilogy(plotDataRom200_orth{2}.xData, abs(plotData{2}.yData-plotDataRom200_orth{2}.yData) ./ abs(plotData{2}.yData), 'ro:', 'LineWidth', linewidth);
semilogy(plotDataRom50{3}.xData, abs(plotData{3}.yData - plotDataRom50{3}.yData) ./ abs(plotData{3}.yData), 'k--', 'LineWidth', linewidth);
semilogy(plotDataRom{3}.xData, abs(plotData{3}.yData - plotDataRom{3}.yData) ./ abs(plotData{3}.yData), 'k', 'LineWidth', linewidth);
semilogy(plotDataRom150{3}.xData, abs(plotData{3}.yData - plotDataRom150{3}.yData) ./ abs(plotData{3}.yData), 'k-.', 'LineWidth', linewidth);
semilogy(plotDataRom100_orth{3}.xData, abs(plotData{3}.yData-plotDataRom100_orth{3}.yData) ./ abs(plotData{3}.yData), 'k:', 'LineWidth', linewidth);
semilogy(plotDataRom150_orth{3}.xData, abs(plotData{3}.yData-plotDataRom150_orth{3}.yData) ./ abs(plotData{3}.yData), 'kx:', 'LineWidth', linewidth);
semilogy(plotDataRom200_orth{3}.xData, abs(plotData{3}.yData-plotDataRom200_orth{3}.yData) ./ abs(plotData{3}.yData), 'ko:', 'LineWidth', linewidth);
xlabel('Frequency (Hz)', 'FontSize', fontsize);
ylabel('|e_i|', 'FontSize', fontsize);
% legend('e_1 - ROM 50', 'e_1 - ROM 100', 'e_2 - ROM 50', 'e_2 - ROM 100', 'e_3 - ROM 50', 'e_3 - ROM 100', ...
%   'Location', 'North');
legend('e_1 - ROM 50', 'e_1 - ROM 100', 'e_1 - ROM 150', 'e_1 - ROM 100 o', 'e_1 - ROM 150 o', ...
    'e_2 - ROM 50', 'e_2 - ROM 100', 'e_2 - ROM 150', 'e_2 - ROM 100 o', 'e_2 - ROM 150 o', ...
    'e_3 - ROM 50', 'e_3 - ROM 100', 'e_3 - ROM 150', 'e_3 - ROM 100 o', 'e_3 - ROM 150 o', 'Location', 'North');
set(gca, 'FontSize', fontsize);
