function [IsPassive,MODpassive] = CheckHamiltonianAllSparseAdaptive(MOD,Options,SparseHamOptions,AdaptiveSamplingOptions,RootFigHandle);
%
%	[IsPassive,MODpassive] = CheckHamiltonianAllSparseAdaptive(MOD,Options,SparseHamOptions,AdaptiveSamplingOptions);
%
...
% used in combination with an adaptive frequency sampling process to
% speed up the determination of imaginary Hamiltonian eigenvalues.
...
% passed in the (optional) structures Options, SparseHamOptions, and
% AdaptiveSamplingOptions. The possible fields are indicated below
% with the defults values (used if the corresponding fields are missing).
% Default values are returned by auxiliary functions GetHamiltonianDefaultOptions,
% GetSparseHamDefaultOptions, and GetAdaptiveSamplingDefaultOptions.
%
% Options
% =======
%
