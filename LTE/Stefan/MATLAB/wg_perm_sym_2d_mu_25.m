...
filename = 'G:\invProblems\wg_perm_sym_1.1e+010_(20,0)_10\s_11_f_8e+009_1.4e+010_101_m_25_25_1.txt';
...
filename = 'G:\invProblems\wg_perm_sym_1.2e+010_(30,0)_12\s_11_f_8e+009_1.4e+010_101_m_25_25_1.txt';
[m, f, s_, de] = readSparamMOR(filename);
plot(f*1e-9, abs(s_)', 'LineWidth', linewidth, 'Color', 'black');

% filename = 'G:\invProblems\sPar_wg_perm_sym_mu20_disc.txt';
