...
filename = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_e1_4_e2_2_new\s_11_f_3e+009_8e+009_201_e1_1_1_1_e2_1_1_1.txt';
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_10\S_f_3e+009_8e+009_201_EPSILON_RELATIVE_Box1_(1,0)_(5,0)_1_EPSILON_RELATIVE_Box2_(1,0)_(3,0)_1.txt';
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_10\S_f_3e+009_8e+009_401_EPSILON_RELATIVE_Box1_(1,0)_(5,0)_1_EPSILON_RELATIVE_Box2_(3,0)_(3,0)_1.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
    = loadSmatrix(fNameSpara);
% plot results
sValO5 = zeros(numParameterPnts(1),1);
...
figHandle = figure;
set(figHandle,'color','w');
filename = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_e1_4_e2_2_new\s_11_f_3e+009_8e+009_201_e1_5_5_1_e2_1_1_1.txt';
[mus, freqs, s] = readSparamMORs11(filename);
abs_s = abs(s);
plot(freqs*1e-9, abs_s', 'LineWidth', linewidth);
set(gca,'FontSize',fontsize)
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_10\S_f_3e+009_8e+009_201_EPSILON_RELATIVE_Box1_(5,0)_(5,0)_1_EPSILON_RELATIVE_Box2_(1,0)_(3,0)_1.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
    = loadSmatrix(fNameSpara);
% plot results
sValO5 = zeros(numParameterPnts(1),1);
...
figHandle = figure;
set(figHandle,'color','w');
filename = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_e1_4_e2_2_new\s_11_f_3e+009_8e+009_201_e1_5_5_1_e2_3_3_1.txt';
[mus, freqs, s] = readSparamMORs11(filename);
abs_s = abs(s);
plot(freqs*1e-9, abs_s', 'LineWidth', linewidth);
set(gca,'FontSize',fontsize)
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_10\S_f_3e+009_8e+009_201_EPSILON_RELATIVE_Box1_(5,0)_(5,0)_1_EPSILON_RELATIVE_Box2_(3,0)_(3,0)_1.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
    = loadSmatrix(fNameSpara);
% plot results
sValO5 = zeros(numParameterPnts(1),1);
...
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_6\S_f_3000000000_8000000000_151_EPSILON_RELATIVE_Box1_5_5_1_EPSILON_RELATIVE_Box2_3_3_1.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
  = loadSmatrix(fNameSpara);
...
%%%%%%%
fNameSpara = 'C:\work\examples\patch_antenna\patch_antenna_modRed\results\patch_antenna_6e+009_EPSILON_RELATIVE_Box1_(4,0)_EPSILON_RELATIVE_Box2_(2,0)_6_intp\S_f_3000000000_8000000000_151_EPSILON_RELATIVE_Box1_5_5_1_EPSILON_RELATIVE_Box2_3_3_1.txt';
[parameterNames, numParameterPnts, parameterVals, sMatrices] ...
  = loadSmatrix(fNameSpara);
...
%   sValIntpShort(fCnt) = sValIntp(find(freqsN == fr(fCnt)));
  sShort(fCnt) = s(logical(freqs == fr(fCnt)));
  sValO5Short(fCnt) = sValO5(logical(freqs10 == fr(fCnt)));
  sValShort(fCnt) = sVal(logical(freqsN == fr(fCnt)));
  sValIntpShort(fCnt) = sValIntp(logical(freqsN == fr(fCnt)));
end
figHandle = figure;
set(figHandle, 'color', 'w');
...
alive = 483732 + 44286 + 22744 + 141403 + 13429 + 7578 + 99577 + 12341 + ...
  5589 + 20159 + 1505 + 1766 + 40;
display(alive);
alive2 = alive + 41826 + 1088 + 1989;
display(alive2);



dof1 = 20159 + 1505 + 1766 + 40 + 41826 + 1088 + 1989 + 99577 + ...
  12341 + 5589;
display(dof1);
...
assUser = 95.0469;
assSys = 1.67188;
assTime = assUser + assSys;
precTime = totalUser + totalSystem - assTime;
display(assTime);
display(precTime);
