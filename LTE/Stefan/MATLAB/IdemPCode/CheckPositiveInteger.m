function outstring = CheckPositiveInteger(editstring, header)
%
%	outstring = CheckPositiveInteger(editstring, header)
%
% Returns an error string if the string <editstring> is not a
% positive integer number. Otherwise, an empty string is returned.
