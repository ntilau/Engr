% This script solves the inverse problem with genetic algorithm
...
x=[20; -0.003063; -2.25e-13]
costFunLinMuImag(x)

% x=[20; -0.013063; -2.25e-13]
% costFunLinMuImag(x)
% 
options = gaoptimset('PopInitRange',initRange);
options = gaoptimset(options,'StallTimeLimit',400);

[muEst, fval, reason, output] = ga(@costFunLinMuImag,3,options)
